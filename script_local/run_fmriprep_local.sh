...
singularity run $my_singularity_img $my_input $my_output participant -w $my_work --output-spaces T1w --participant-label 007 --cifti-output 91k --bids-filter-file /home/pabaua/dev_tpil/tpil_dmri/script_local/fmriprep_bids_filter.json --fs-subjects-dir /home/pabaua/dev_tpil/data/Freesurfer/freesurfer_v1
