...
my_participants='002 006 007 008 010 012 013 014 015 016 017 019 021 022 023 024 025 027 029 030 031 032 034 036 037 038 039 040 041 042 046 047 048 049 050 051 052 053 055 056 057 058 059 060 061 062 063 064 065'
...
apptainer run --cleanenv -B /project:/project -B /scratch:/scratch $my_singularity_img $my_input $my_output participant -w $my_work --output-spaces T1w --cifti-output 91k --bids-filter-file $bids_filter --fs-subjects-dir $fs_dir
#done