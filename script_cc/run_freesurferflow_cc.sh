...
my_singularity_img='/home/pabaua/projects/def-pascalt-ab/pabaua/dev_scil/containers/scil_freesurfer.img' # or .img
...
nextflow run $my_main_nf --root_fs_output $my_input --atlas_utils_folder $atlas_utils \
